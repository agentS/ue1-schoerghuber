...
curl -X PUT -i http://localhost:8080/fhbay/api/customers/update/3 -H "Content-Type: application/json" --data '{"email":"marge.simpson@burnspowerplant.com","firstName":"Marge","id":6,"lastName":"Simpson","password":"ILoveHomerSimpson","username":"marge.simpson"}'
